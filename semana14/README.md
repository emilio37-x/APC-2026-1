...
Também foram exploradas as principais caixas de diálogo disponíveis no Tkinter, como mensagens de informação, mensagens de erro, confirmação, seleção de arquivos e entrada de texto pelo usuário.
